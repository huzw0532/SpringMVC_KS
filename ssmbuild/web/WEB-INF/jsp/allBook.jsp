                    ...
                    <c:forEach var="book" items="${list}">
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-warning btn-xs" href="${pageContext.request.contextPath}/book/toUpdate?id=${book.bookID}">修改</a>
                                <a class="btn btn-danger btn-xs" href="${pageContext.request.contextPath}/book/toDelete/${book.bookID}">删除</a>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
